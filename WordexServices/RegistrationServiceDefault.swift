...
public class RegistrationServiceDefault: RegistrationService {
    ...
    public init(ctxwlUrlSession: CTXWLURLSession, userService: UserService) {
    ...
    public var requireVerification: AnyPublisher<Bool, Never> {
    ...
    public func resetRegistrationStatus() -> Void {
        registrationStatus = .NotRegistered
        _requireVerification.send(false)
    }
    
    public func currentRegistrationStatus() -> RegistrationStatus {
        return registrationStatus
    }
    
    public func requestEmailConfirmation() -> AnyPublisher<Result<Void, CLIENT_ERROR>, Never> {
...
//         make the request happen and store the application key
    ...
    public func register(confirmationCode: String) -> AnyPublisher<Result<Void, CLIENT_ERROR>, Never> {
