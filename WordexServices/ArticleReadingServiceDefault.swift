...
@available(iOS 15, *)
public class ArticleReadingServiceDefault: ArticleReadingService, SessionConnectionService {
    ...
    public func readNewArticle(url: String, fullText: String) throws -> Article {
    ...
    public func removeArticleHolder(key: Int) {
        self.articleList.removeValue(forKey: key)
    }
    
    public func switchToWeakArticle(entrySerial: Int) {
